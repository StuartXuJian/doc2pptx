...
def createSlide(presentation, slideNumber, slideInfo):
    ...
    footerBoxTop = presentation.slide_height - numbersHeight / 2 - footerFontSize
    ...
    if slideInfo.blockType in ["title", "section"]:
        ...
        if slideInfo.blockType == "section":
            presentation.lastSectionTitle = slideInfo.titleText.strip()
            presentation.lastSectionSlide = slide
        elif slideInfo.blockType == "title":
            presentation.lastPresTitle = slideInfo.titleText.strip()
            presentation.lastPresSubtitle = slideInfo.subtitleText.strip()
    ...
    if wantFooters:
        ...
        if leftFooterText != "":
            ...
            leftFooterBoxWidth = presentation.slide_width / 3 - leftFooterMargin
        ...
        if middleFooterText != "":
            middleFooterBoxLeft = presentation.slide_width / 3
            middleFooterBoxWidth = presentation.slide_width / 3
            ...
            if wantHyperLink:
                createShapeHyperlinkAndTooltip(middleFooter, presentation.lastSectionSlide, "")
        ...
        if rightFooterText != "":
            ...
            rightFooterBoxLeft = presentation.slide_width * 2 / 3
            rightFooterBoxWidth = presentation.slide_width / 3 - rightFooterMargin
            ...
            if wantHyperLink:
                createShapeHyperlinkAndTooltip(rightFooter, presentation.lastSectionSlide, "")
...
def Starting_info():
    global banner
    banner = (
        "doc2pptx Markdown To Powerpoint Converter " + md2pptx_level + " " + md2pptx_date
    )
    ...
    print("\n" + banner + "\n" + bannerUnderline)
    print("\nOpen source project: https://github.com/StuartXuJian/doc2pptx")
...
def convert(inputFileName="NULL") -> str:
    ...
    for lineNumber, line in enumerate(linesAfterConcatenation):
        ...
        # to either a new or existing table. It also says we're in a table
            ...
            # There is at least one media item in the line - so set up table
            if inTable is False:
